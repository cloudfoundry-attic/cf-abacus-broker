...
// Setup debug log
const debug = require('abacus-debug')('abacus-ext-plan-mappings');
const edebug = require('abacus-debug')('e-abacus-ext-plan-mappings');
...
const mappings = path.join(path.dirname(
  require.resolve('abacus-plan-mappings')), 'plans');
