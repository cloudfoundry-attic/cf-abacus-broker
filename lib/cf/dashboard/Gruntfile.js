...
module.exports = function(grunt) {
    grunt.initConfig({
        ...
        jshint: {
            ...
            build: ['Gruntfile.js', 'src/webapp/components/**/*.js']
        },
        uglify: {
            options: {
    ...
    grunt.registerTask('prod', ['npm-install', /*'jshint',*/ 'concat', 'ngAnnotate', 'uglify']);
    grunt.registerTask('dev', ['npm-install', /*'jshint',*/ 'concat', 'ngAnnotate', ]);
    grunt.registerTask('serve', [ /*'jshint',*/ 'concat', 'ngAnnotate', 'uglify', 'less:development']);
    grunt.registerTask('watchboth', ['watch:set1', 'watch:set2']);
