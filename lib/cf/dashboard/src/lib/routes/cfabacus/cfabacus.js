...
router.get('/metering/plans/:plan_id', authenticate.ensureAuthenticated, (request, response) => {
...
router.put('/metering/plan/:plan_id', authenticate.ensureAuthenticated, (request, response) => {
