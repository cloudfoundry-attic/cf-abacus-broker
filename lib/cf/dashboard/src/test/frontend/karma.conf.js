...
module.exports = function(config) {
  config.set({
    ...
    files: [
      '../../webapp/libs/karma-read-json/karma-read-json.js',
      '../../webapp/libs/jquery/dist/jquery.js',
      '../../webapp/libs/lodash/dist/lodash.min.js',
      '../../webapp/libs/angular/angular.js',
      '../../webapp/libs/angular-sanitize/angular-sanitize.js',
      '../../webapp/libs/angular-ui-router/release/angular-ui-router.min.js',
      '../../webapp/libs/angular-breadcrumb/release/angular-breadcrumb.min.js',
      ...
      '../../webapp/libs/clipboard/dist/clipboard.min.js',
      '../../webapp/libs/ngclipboard/dist/ngclipboard.min.js',
