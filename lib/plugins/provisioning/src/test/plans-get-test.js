...
describe('abacus-provisioning-plugin plans get metering',
  () => testGetOfPlan('metering', generateMeteringPlan, meteringdb));

describe('abacus-provisioning-plugin plans get pricing',
  () => testGetOfPlan('pricing', generatePricingPlan, pricingdb));

describe('abacus-provisioning-plugin plans get rating',
