...
const deleteModules = (cb = () => {}) => {
  delete require.cache[require.resolve('abacus-ext-plan-mappings')];
...
describe('abacus-ext-provisioning-plugin validation', () => {
  let provisioning;
  ...
  beforeEach((done) => {
    deleteModules();
    mappings = require('abacus-ext-plan-mappings');
  ...
  it('returns resource instance info by org/space/app/resource/plan/instance',
    (done) => {
