...
const testPostOfPlan = (planType, plan, db) => {
  ...
  it(`validate error tring to create already existing ${planType} plan`,
    (done) => {
...
describe('abacus-provisioning-plugin plans creation metering',
  () => testPostOfPlan('metering', meteringPlan, meteringdb));
describe('abacus-provisioning-plugin plans creation pricing',
